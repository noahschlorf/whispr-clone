...
# Copy executable (binary now auto-detects bundle resources path)
cp "$BUILD_DIR/voxtype" "$APP_BUNDLE/Contents/MacOS/VoxType"
...
# Code sign the app bundle (ad-hoc signing for local use)
